      ...
      <div className="min-h-screen bg-slate-50/50 p-6 lg:p-10 flex flex-col gap-8">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <button 
            ...
            className="w-auto self-start lg:self-auto bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-5 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all font-bold flex items-center gap-2 text-sm whitespace-nowrap disabled:shadow-none"
          >
